...
namespace Materias
{
    public partial class Form1 : Form
    {
        ...
        public void Carga2()
        {
            ...
            string[] Materias = File.ReadAllLines(direccion + "\\PlanDeEstudio.csv");
